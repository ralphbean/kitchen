...
_COMBINING = (
        ...
        (0x10d24, 0x10d27), (0x10f46, 0x10f50), (0x11046, 0x11046),
        ...
        (0x1133b, 0x1133c), (0x1134d, 0x1134d), (0x11366, 0x1136c),
        (0x11370, 0x11374), (0x11442, 0x11442), (0x11446, 0x11446),
        (0x1145e, 0x1145e), (0x114c2, 0x114c3), (0x115bf, 0x115c0),
        (0x1163f, 0x1163f), (0x116b6, 0x116b7), (0x1172b, 0x1172b),
        (0x11839, 0x1183a), (0x11a34, 0x11a34), (0x11a47, 0x11a47),
...
This table was last regenerated on python-3.7.3 with
:data:`unicodedata.unidata_version` 11.0.0
'''
